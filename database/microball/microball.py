...
class microball:
    def __init__(self, path = None, coordinate = 'uball'):
        if path is None:
            self.path = pathlib.Path("uball_geometry.dat")
        else:
    ...
    def read_geometry(self):
        self.geometry = pd.read_csv(self.path, delim_whitespace = True, comment = '#', index_col = False)
...
if __name__ == '__main__':
    uball = microball("./acceptance/uball_geometry.dat", 'uball')
    df = uball.geometry
